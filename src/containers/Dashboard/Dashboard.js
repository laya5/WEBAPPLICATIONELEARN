    ...
    <Fragment>
      ...
      <Box my={5} style={{ minHeight: 520 }}>
        <Box mx={6} py={3}>
          ...
          <Typography variant="subtitle1" gutterBottom>
            Choose from many online video courses with new additions published
            every decade
          </Typography>
        </Box>
        <CourseList />
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} minWidth={315} alignSelf="center">
            ...
            <Box mt={3}>
              <Typography>
                Simply sign up as a verified user on SkillUp to start to
        ...
        >
            ...
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                ...
                <Typography style={{ marginTop: 16 }}>
                  SkillUp is collection on many resourses. People who study at
                  the SkillUp can archive knowledge by join suitable topic.
                </Typography>
              </Box>
            </Box>
          </Box>
          ...
          <Box alignSelf="flex-start" maxWidth={500} m={5}>
            <Box display="flex">
              ...
              <Box ml={1} display="flex" flexDirection="column">
                <Typography variant="h4">
                  SkillUp users can easily achieve the desired skills
                </Typography>
                <Typography style={{ marginTop: 16 }}>
                  SkillUp system is meticulously built to enhance the
      ...
      <Box className={classes.intro}>
        ...
        >
          <Box mx={5} mt={5} minWidth={315} alignSelf="center">
            <Box>
              <Typography variant="h4" color="inherit">
                A bunch of courses are waiting you
              </Typography>
            </Box>
            <Box mt={3}>
              <Typography> join us now!</Typography>
            </Box>
            {user ? null : (
              <Box mt={2}>
                <Button
